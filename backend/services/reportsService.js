...
async generatePDF(htmlContent, options = {}) {
  ...
  try {
    ...
    const pdfOptions = {
      ...
      footerTemplate: `
        <div style="width: 100%; font-size: 9px; padding: 10px 40px; text-align: center; border-top: 1px solid #e5e7eb; color: #6b7280;">
          <p style="margin: 0;">This report was automatically generated by Lumiere Insurance Management System</p>
          <p style="margin: 2px 0;">© ${new Date().getFullYear()} Lumiere Insurance. All rights reserved. | Page <span class="pageNumber"></span> of <span class="totalPages"></span></p>
        </div>
      `,
      margin: {
        top: '0mm',
