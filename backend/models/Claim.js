...
ClaimSchema.methods.loadQuestionnaire = async function () {
   try {
      ...
      console.log("the template: ",template.sections[0].questions[0].validation)
      ...
      console.log("the claim: ",this.questionnaire.sections[0].responses[0].validation)
      return this.save();
   } catch (error) {
      throw error;
   }
