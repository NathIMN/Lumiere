...
export function HeaderLanding({ scrolled }) {
   ...
   return (
         ...
         <div className="flex items-center gap-8">
            <a href="#home" onClick={(e) => { e.preventDefault(); scrollToSection('home'); }}>
               <div className="inline-flex items-center gap-3 col-span-2">
                  {/* Logo */}
                  <img
                     src={scrolled ? "/lum1.png" : "/lum2.png"}
                     alt="Lumiere Logo"
    ...
    ${activeSection === item.id
                           ? 'bg-white text-red-900 font-medium' // ✅ active: always white bg + red text
                           : scrolled
                              ? 'text-white hover:bg-white/10 hover:text-red-900' // ✅ scrolled but not active
                              : 'text-red-900 hover:bg-white/10 hover:text-red-900' // ✅ not scrolled, not active
                        }`}
                  >
                     {item.label}
                  </button>
