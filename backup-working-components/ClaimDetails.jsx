  ...
  const fetchClaimDetails = async () => {
    try {
      ...
      if (claimData.questionnaire) {
        ...
        if (claimData.questionnaire.sections) {
          claimData.questionnaire.sections.forEach(section => {
            ...
            {questionnaire && (
              <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-gray-200 dark:border-neutral-700 p-8 shadow-lg">
                ...
                {questionnaire.isComplete ? (
                  ...
                  // Show button to open questionnaire
      ...
      {showQuestionnaireModal && questionnaire && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="relative w-full max-w-4xl bg-gray-100 dark:bg-neutral-800 rounded-2xl shadow-2xl max-h-[90vh] overflow-hidden border border-gray-200 dark:border-neutral-700">
              {/* Modal Header */}
              <div className="sticky top-0 z-10 bg-[#f5c0b8] dark:bg-neutral-700 border-b border-slate-200 dark:border-neutral-600 px-6 py-4">
